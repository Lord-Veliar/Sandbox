...
namespace Sandbox_Club
{
    public partial class Glavnaya : Form
    {
       ...
       g.button1.Enabled = false;
            ...
            g.pictureBox2.Image = Properties.Resources.гончар;
            this.Close();
        }
        ...
        private void ebru_Click(object sender, EventArgs e)
        {
            ...
            g.pictureBox2.Image = Properties.Resources.эбру;
            this.Close();
        }
        ...
        private void holiday_Click(object sender, EventArgs e)
        {
            ...
            g.pictureBox2.Image = Properties.Resources.праздники;
            this.Close();
        }
        ...
        private void music_Click(object sender, EventArgs e)
        {
            ...
            g.pictureBox2.Image = Properties.Resources.музыка;
            this.Close();
        }
        ...
        private void drawing_Click(object sender, EventArgs e)
        {
            ...
            g.Opis.Text = "Рисование песком - это то, с чего начинала свое существование наша организация. Здесь Вы можете проявить свои творческие способности крайне необычным способом. Вы не только сможете создать настоящее произведение искусства, а еще - расслабиться и отдохнуть душевно. Вам будут помогать наши специалисты, а на фоне этой успокаивающей тишины в полумраке будет играть едва слышная приятная музыка";
            g.pictureBox2.Image = Properties.Resources.песок;
            this.Close();
        }
